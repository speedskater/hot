...
/**
 * Helper structure for use in conjunction with { @link spider::idx::STLLikeIndex }
...
/**
 * A template specialization which allows the handling of pair like types in conjunction with STLLikeIndex.
